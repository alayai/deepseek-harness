...
export const en = {
  ...
  pluginManagerDescription: 'Plugins are installed only in the Desktop node_modules and are managed by the bundled pnpm. You can install a registry package or a local .tgz file.',
  refresh: 'Refresh',
  enable: 'Enable',
  disable: 'Disable',
  disabled: 'Disabled',
...
export const zh = {
  ...
  pluginManagerDescription: '插件只安装到桌面端自己的 node_modules，并由内置 pnpm 管理。可安装 registry 包或本地 .tgz 文件。',
  refresh: '刷新',
  enable: '启用',
  disable: '禁用',
  disabled: '已禁用',
