...
export const zh = {
  ...
  'view.openSide': '在右侧打开 {label}',
  'view.closeSide': '关闭右侧的 {label}',
  'view.resize': '调整分栏宽度',
  'todo.title': '任务',
...
export const en = {
  ...
  'view.openSide': 'Open {label} to the side',
  'view.closeSide': 'Close {label} on the side',
  'view.resize': 'Resize side view',
  'todo.title': 'To-dos',
